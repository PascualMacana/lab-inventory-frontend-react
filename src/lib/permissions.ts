...
const permisosJefe = new Set([
  ...
  "editar_solicitud_compra_propia",
  "editar_solicitud_compra",
  "aprobar_solicitud_compra",
  "preparar_comunicacion_compra",
  "registrar_recepcion_compra",
  "ver_costos_compra",
...
const accionModulo: Record<string, string> = {
  ...
  editar_solicitud_compra_propia: "compras",
